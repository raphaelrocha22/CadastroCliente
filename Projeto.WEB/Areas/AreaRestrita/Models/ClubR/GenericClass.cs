...
namespace Projeto.WEB.Areas.AreaRestrita.Models.ClubR
{
    public class GenericClass
    {
        ...
        public static List<GenericClass> PrazoPagamento_Desconto()
        {
            ...
            lista.Add(new GenericClass { PrazoPagamento = "2 Vezes", Desconto = 0.3M });
            ...
            lista.Add(new GenericClass { PrazoPagamento = "3 Vezes", Desconto = 0.3M });
            ...
            lista.Add(new GenericClass { PrazoPagamento = "4 Vezes", Desconto = 0.3M });
